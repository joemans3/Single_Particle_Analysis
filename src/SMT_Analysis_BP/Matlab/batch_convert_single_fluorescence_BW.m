clear
a = which('rp_m9_fixed_01.vsi'); %give it an initial file to start with 
filelist = dir([fileparts(a) filesep 'rp_m9_fixed_*.vsi']);
...
filename=sprintf('rp_m9_fixed_%d.tif',k);
