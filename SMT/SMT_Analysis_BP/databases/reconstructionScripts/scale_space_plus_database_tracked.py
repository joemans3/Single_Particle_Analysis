...
from SMT.SMT_Analysis_BP.helpers.analysisFunctions.scale_space_plus import SM_reconstruction_image
...
from SMT.SMT_Analysis_BP.databases.reconstructionScripts.scale_space_plus_fixed_palm import get_unique_localizations
#import DBSCAN
#import convex hull
CORRECTION_FACTOR=1.
...
class segmentation_scale_space:
    ...
    def main_run(self):
        ...
        for i in range(len(SMT_data)):
            ...
            #get the movie ID
            movie_ID = file_name.split('_seg.tif_spots.csv')[0].split(self.t_string+'_')[1]
